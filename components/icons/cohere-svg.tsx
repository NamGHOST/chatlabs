...
interface CohereSVGProps {
  width?: number
  height?: number
  className?: string
}

export const CohereSVG: FC<CohereSVGProps> = ({
  width = 40,
  height = 40,
  className
}) => {
  return (
    ...
    >
      <path
        ...
        clipRule="evenodd"
        fill="#39594D"
        d="M24.3,44.7c2,0,6-0.1,11.6-2.4c6.5-2.7,19.3-7.5,28.6-12.5c6.5-3.5,9.3-8.1,9.3-14.3C73.8,7,66.9,0,58.3,0h-36C10,0,0,10,0,22.3S9.4,44.7,24.3,44.7z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
