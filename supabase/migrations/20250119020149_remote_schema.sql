...
drop policy "Allow insert/update access for service_role" on "public"."platform_tools";

drop policy "Allow read access for authenticated users" on "public"."platform_tools";
